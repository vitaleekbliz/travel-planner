...
# class ProjectNotFoundError(ProjectBaseError):
#     """Raised when a specific project ID/name is not found."""
#     def __init__(self, identifier: int | str):
#         self.identifier = identifier
        
#         if isinstance(identifier, int):
#             message = f"Project with ID '{identifier}' could not be found."
#         else:
#             message = f"Project with Name '{identifier}' could not be found."
